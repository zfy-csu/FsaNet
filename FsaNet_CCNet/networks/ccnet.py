...
class PSPModule(nn.Module):
    ...
    def __init__(self, features, out_features=512, sizes=(1, 2, 3, 6)):
        ...
        self.bottleneck = nn.Sequential(
            ...
            BatchNorm2d(out_features), nn.ReLU(inplace=False), #InPlaceABN(out_features),
            nn.Dropout2d(0.1)
            )
    ...
    def _make_stage(self, features, out_features, size):
        ...
        bn = BatchNorm2d(out_features), nn.ReLU(inplace=False)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes, criterion, recurrence):
        ...
        self.dsn = nn.Sequential(
            ...
            BatchNorm2d(512), nn.ReLU(inplace=False),#InPlaceABN(512),
            nn.Dropout2d(0.1),
            nn.Conv2d(512, num_classes, kernel_size=1, stride=1, padding=0, bias=True)
            )
